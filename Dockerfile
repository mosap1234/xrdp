...
# تحديث وتثبيت الواجهة الأساسية وسيرفر VNC (بدون أدوات المتصفح)
RUN apt update -y && apt install --no-install-recommends -y \
    xfce4 xfce4-goodies tigervnc-standalone-server sudo xterm \
...
# إعداد مجلد VNC والباسورد اللي طلبته للمستخدم root
...
# أمر التشغيل: ينظف الملفات المعلقة ثم يشغل السيرفر ويراقب السجلات
